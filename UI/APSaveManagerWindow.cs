...
namespace OneShot.Archipelago.UI
{
    public class APSaveManagerWindow : ModWindow
    {
            ...
            : base("AP Save Manager", "oneshot", W, H, addCloseButton: true, addMinimizeButton: true)
        {
            ...
            AddControl(new Button("▼", new Vec2(PAD + 50, y),    OnSelectDown));
            AddControl(new Button("Load",   new Vec2(PAD + 100, y),   OnLoadSelectedClicked));
            AddControl(new Button("Delete", new Vec2(PAD + 150, y),  OnDeleteClicked));
        ...
        protected override void OnUpdate()
        {
            ...
            if (APSaveManager.IsAPModeActive)
                _statusLabel.Text = $"Active: {APSaveManager.ActiveSaveKey}";
            else
        ...
        private void OnConnectClicked()
        {
            ...
            _statusLabel.Text = $"Loading {info.Key}...";
    ...
    canAutomash: true
        ...
        private void RefreshSaveList()
        {
            ...
            for (int i = 0; i < _saves.Count; i++)
            {
                ...
                string nm  = s.SlotName.Length > 18 ? s.SlotName.Substring(0, 18) : s.SlotName;
